...
handled. It extends rather than replaces [`docs/ethics_and_release.md`](docs/ethics_and_release.md).

## Standing posture

1. **Science is the goal; safety is the constraint.** We publish frameworks, methods, statistics, and
   non-sensitive findings openly. We publish nothing that functions as a deployable attack or a
...
standing policy and a contingency protocol rather than a report of any disclosed vulnerability.
...
elicitation specifics are excluded (see [`MANIFEST.md`](MANIFEST.md)).
