...
refactoring, and reviewing code; assisting with statistical implementation; triaging literature;
...
- **Clear accountability.** AI tools assisted the work; they did not author it. This disclosure
  exists so that human authorship and responsibility are unambiguous.
- **Coordinated disclosure.** Any safety-relevant finding is handled per `DISCLOSURE.md`.

---

*This is the author's disclosure of his own use of AI tools. It is not authored or owned by any AI
system or provider; it records, transparently, that such tools assisted a project whose principal
and responsible party is Pablo Zavala.*
